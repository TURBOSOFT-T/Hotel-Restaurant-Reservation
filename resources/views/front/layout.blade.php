...
<head>
 ...
 <!--- basic page needs
    ================================================== -->
    <meta charset="utf-8">
    <title>{{ isset($menu) && $menu->seo_title ? $menu->seo_title :  config('app.name') }}</title>
    <meta name="description" content="{{ isset($menu) && $menu->meta_description ? $menu->meta_description : __(config('app.description')) }}">
    <meta name="author" content="{{ isset($menu) ? $menu->user->name : __(config('app.author')) }}">
    @if(isset($menu) && $menu->meta_keywords)
            ...
            <div class="row">
                <div class="column">
                    <div class="ss-copyright">
                        <span>© Copyright Turbosoft 2023</span>
